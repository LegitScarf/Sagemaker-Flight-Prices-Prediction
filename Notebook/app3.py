...
<style>
    ...
    /* Spinner styling for dark theme */
    .stSpinner > div {
    ...
    with st.spinner('🔮 Analyzing flight data and predicting price...'):
        try:
            ...
            <div class="result-container animated-result">
                <h2 style="color: #ffffff; margin-bottom: 1rem;">🎯 Predicted Flight Price</h2>
                ...
                <div style="margin-top: 2rem; padding: 1rem; background: rgba(0, 212, 255, 0.1); border-radius: 10px; border: 1px solid rgba(0, 212, 255, 0.2);">
                    <h4 style="color: #00d4ff; margin-bottom: 0.5rem;">📊 Flight Summary</h4>
                    <p style="margin: 0.25rem 0; color: #ffffff;"><strong>Route:</strong> {source} → {destination}</p>
                    <p style="margin: 0.25rem 0; color: #ffffff;"><strong>Airline:</strong> {airline}</p>
                    <p style="margin: 0.25rem 0; color: #ffffff;"><strong>Duration:</strong> {duration} minutes</p>
                    <p style="margin: 0.25rem 0; color: #ffffff;"><strong>Stops:</strong> {total_stops}</p>
                </div>
            </div>
            """, unsafe_allow_html=True)
...
# Footer
st.markdown("""
<div style="text-align: center; padding: 2rem; color: #cccccc; border-top: 1px solid rgba(255, 255, 255, 0.1); margin-top: 3rem;">
